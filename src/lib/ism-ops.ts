...
export const ORDER_STATUS_GROUPS: { group: string; statuses: string[] }[] = [
  ...
  {
    group: "Fulfilment",
    statuses: ["ORDER_CREATED", "SELLER_NOTIFIED", "SELLER_ACCEPTED", "PREPARING", "READY_TO_SHIP"],
  },
  {
    group: "Shipping",
    statuses: [
  ...
  subOrders: [
    {
      ...
      timeline: [
        ...
        { label: "Out for delivery", at: "28 Aug, 7:05am", done: true },
        {
          ...
          note: "Left in a safe place — photo POD on file",
        },
      ],
    },
    {
      ...
      timeline: [
        ...
        { label: "Shipped", at: "27 Aug, 6:40pm", done: true },
        {
          ...
          note: "Processed at Melbourne facility",
        },
...
export const LEDGER: LedgerRow[] = [
  {
    ref: "TXN-2026-0009812",
    type: "Customer Charge",
    amount: 412,
    order: "ISM10001",
    seller: "—",
    at: "24 Aug 2026 19:42",
    status: "Posted",
    source: "Payment provider (demo)",
  },
  {
    ref: "TXN-2026-0009813",
  ...
  {
    ref: "TXN-2026-0009817",
    type: "Shipping Cost",
    amount: -21.4,
    order: "ISM10001-B",
    seller: "Jaipur Jewel House",
    at: "27 Aug 2026 18:40",
    status: "Posted",
    source: "Carrier (demo)",
  },
  {
    ref: "TXN-2026-0009901",
    type: "Refund",
    amount: -49,
    order: "ISM09984-B",
    seller: "Jaipur Jewel House",
    at: "29 Aug 2026 10:05",
    status: "Posted",
    source: "Return RET-4390",
  },
  {
    ref: "TXN-2026-0009902",
    type: "Adjustment",
    amount: -12.5,
    order: "ISM09984-B",
    seller: "Jaipur Jewel House",
    at: "29 Aug 2026 10:06",
    status: "Posted",
    source: "Post-payout recovery",
  },
  {
    ref: "TXN-2026-0009950",
    type: "Payout",
    amount: -4182.4,
    order: "BATCH-PO-2026-36",
    seller: "Mumbai Mirror Boutique",
    at: "29 Aug 2026 17:00",
    status: "Pending",
    source: "Payout batch (demo)",
  },
  {
    ref: "TXN-2026-0009951",
    type: "Payout",
    amount: -1620,
    order: "BATCH-PO-2026-36",
    seller: "Sydney Silk Studio",
    at: "29 Aug 2026 17:00",
    status: "Held",
    source: "Manual hold — open dispute",
  },
];
...
export const PAYOUT_STAGES = [
  {
    stage: "Pending",
    note: "Order paid, delivery not yet confirmed",
    amount: 2905.1,
    tone: "muted" as Tone,
  },
  {
    stage: "On Hold",
    note: "Open return, dispute, chargeback or fraud review",
    amount: 318,
    tone: "warn" as Tone,
  },
  {
    stage: "Eligible",
    note: "Confirmed delivery + 14 days, no open issues",
    amount: 4182.4,
    tone: "ok" as Tone,
  },
  {
    stage: "Processing",
    note: "Included in the current payout batch",
    amount: 1240,
    tone: "info" as Tone,
  },
  {
    stage: "Paid",
    note: "Settled to the seller's payout account",
    amount: 186340,
    tone: "muted" as Tone,
  },
];
...
export const INTEGRATIONS = [
  {
    ...
    area: "Payments",
    state: "Not connected (adapter ready)",
  ...
  },
  {
    ...
    area: "Shipping",
    state: "Not connected (adapter ready)",
    events: "shipment.created, label.ready, tracking.update",
    tone: "warn" as Tone,
  },
  {
    name: "Media pipeline",
    area: "Product video",
    state: "Not connected (adapter ready)",
    events: "upload.complete, transcode.done, safety.flagged",
    tone: "warn" as Tone,
  },
  {
...
export const WEBHOOK_EVENTS = [
  ...
  },
  {
    ...
    provider: "Shipping",
    type: "label.ready",
    received: "31 Aug 09:41",
    signature: "Failed (demo)",
    state: "Failed",
    attempts: 3,
  },
  {
...
export const AUDIT_LOG = [
  {
    at: "31 Aug 2026 12:04",
    actor: "admin@ism.demo",
    role: "Super Admin",
    action: "PAYOUT_HOLD_APPLIED",
    target: "Sydney Silk Studio",
    detail: "Reason: open dispute over $500",
    ip: "203.0.113.4",
  },
  {
    at: "31 Aug 2026 11:20",
    actor: "finance@ism.demo",
    role: "Finance Admin",
    action: "ADJUSTMENT_POSTED",
    target: "TXN-2026-0009902",
    detail: "Post-payout refund recovery -$12.50",
    ip: "203.0.113.9",
  },
  {
    at: "30 Aug 2026 17:48",
    actor: "ops@ism.demo",
    role: "Catalogue Admin",
    action: "PRODUCT_REJECTED",
    target: "ism-3110",
    detail: "Restricted keyword in title",
    ip: "203.0.113.22",
  },
  {
    at: "30 Aug 2026 09:12",
    actor: "admin@ism.demo",
    role: "Super Admin",
    action: "SELLER_APPROVED",
    target: "Desi Ghar Homewares",
    detail: "ABN and dispatch address verified",
    ip: "203.0.113.4",
  },
  {
    at: "29 Aug 2026 15:31",
    actor: "meera@mumbaimirror.demo",
    role: "Seller Owner",
    action: "STAFF_PERMISSION_CHANGED",
    target: "simran@mumbaimirror.demo",
    detail: "Granted: inventory",
    ip: "198.51.100.14",
  },
];
...
export const READINESS_LEGEND: { state: Readiness; tone: Tone; meaning: string }[] = [
  {
    state: READINESS.PROTOTYPE,
    tone: "ok",
    meaning: "Flow, screens and demo state fully represent the intended behaviour.",
  },
  {
    state: READINESS.PARTIAL,
    tone: "info",
    meaning: "Some screens or states exist; the flow is not yet end-to-end.",
  },
  {
    state: READINESS.BACKEND,
    tone: "warn",
    meaning: "Server-authoritative logic, security or a live provider is required. Not done.",
  },
  {
    state: READINESS.MISSING,
    tone: "bad",
    meaning: "Not represented anywhere in the prototype yet.",
  },
];
...
export const LAUNCH_CHECKLIST: {
...
}[] = [
  {
    ...
    scenario:
      "Draft → submitted → under review → approved, with ABN, dispatch/return address and agreements",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "ABN / identity verification",
    scenario: "ABR lookup, ID document check, sanctions screening",
    state: READINESS.BACKEND,
    note: "No ABR or KYC provider connected.",
  },
  {
    area: "Payout profile",
    scenario: "Bank/payout account captured and verified",
    state: READINESS.BACKEND,
    note: "Placeholder only — payout provider onboarding not connected.",
  },
  {
    area: "Single listing",
    scenario:
      "Category/subcategory, variants, SKUs, inventory, weight/dimensions, handling time, return eligibility, images + video",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Listing moderation",
    scenario: "Admin approve/reject with reasons and restricted-keyword rules",
    state: READINESS.PARTIAL,
    note: "Queue and decisions demoed; rule engine is server-side work.",
  },
  {
    area: "Bulk import — create",
    scenario: "1,000-row CSV/XLSX create run with validation and preview counts",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Bulk import — update",
    scenario: "Explicit update mode keyed on seller SKU, with blank-cell IGNORE vs CLEAR",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Bulk import — async workers",
    scenario: "Large files queued, chunked, resumable, retry of failed rows",
    state: READINESS.BACKEND,
    note: "Batch/queue UI demoed; no job runner.",
  },
  {
    area: "Product video pipeline",
    scenario: "Upload → safety check → transcode → thumbnail → ready / failed, no autoplay sound",
    state: READINESS.PARTIAL,
    note: "All states rendered; media/safety provider not connected.",
  },
  {
    area: "Video moderation",
    scenario: "Admin can review, reject and remove a live product video",
    state: READINESS.PARTIAL,
    note: "Admin action demoed; takedown propagation needs backend.",
  },
  {
    area: "Customer journey",
    scenario:
      "Search → filter → storefront → PDP → cart → checkout → confirmation → orders → tracking → returns → reviews → wishlist",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Guest vs account checkout",
    scenario: "Guest checkout with email, or sign-in, both reaching one order",
    state: READINESS.PARTIAL,
    note: "UI choice present; no real auth or session.",
  },
  {
    area: "Multi-seller checkout",
    scenario: "One cart and one payment → master order → seller sub-orders and packages",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Seller data isolation",
    scenario: "A seller can only ever read their own sub-orders, customers and finance",
    state: READINESS.BACKEND,
    note: "Represented in UI; must be enforced server-side with row-level rules.",
  },
  {
    area: "Inventory reservation",
    scenario: "Stock reserved at checkout; simultaneous buyers cannot oversell",
    state: READINESS.BACKEND,
    note: "Requires transactional reservation and release-on-expiry.",
  },
  {
    area: "Payment capture",
    scenario: "Order marked paid only on provider-confirmed server callback",
    state: READINESS.BACKEND,
    note: "No payment provider connected.",
  },
  {
    area: "Payment idempotency",
    scenario: "Duplicate callback does not double-charge or duplicate the order",
    state: READINESS.BACKEND,
  },
  {
    area: "Financial ledger",
    scenario:
      "Immutable entries for charge, commission, fees, shipping, refund, adjustment, payout",
    state: READINESS.PARTIAL,
    note: "Ledger view and entry types demoed; immutability is a DB guarantee.",
  },
  {
    area: "Shipping rates & labels",
    scenario: "Rate quote → label → pickup → tracking → POD",
    state: READINESS.BACKEND,
    note: "Adapter-ready screens; carrier NOT CONNECTED.",
  },
  {
    area: "Returns",
    scenario:
      "7-day change of mind from confirmed delivery; ACL issues handled separately; item/qty/reason/evidence; partial or full",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Return logistics",
    scenario: "Return label, instructions, return tracking, receipt scan, refund trigger",
    state: READINESS.PARTIAL,
    note: "States shown; label and refund execution need providers.",
  },
  {
    area: "Payout eligibility",
    scenario:
      "Confirmed delivery + 14 days, blocked by return, refund, dispute, chargeback or fraud hold",
    state: READINESS.PROTOTYPE,
  },
  {
    area: "Payout execution",
    scenario: "Batch, failed payout, retry, statement, recovery adjustment",
    state: READINESS.BACKEND,
    note: "Pipeline visualised; no payout rail connected.",
  },
  {
    area: "Seller staff permissions",
    scenario: "Owner/Manager/Dispatch/Finance permission matrix with MFA",
    state: READINESS.PARTIAL,
    note: "Matrix editable in prototype; enforcement is server-side.",
  },
  {
    area: "Admin role separation",
    scenario:
      "Support / Catalogue / Finance / Super Admin scopes, sensitive finance actions audited",
    state: READINESS.PARTIAL,
  },
  {
    area: "Notifications",
    scenario: "Templates, per-event delivery log, retries and failures",
    state: READINESS.PARTIAL,
    note: "Email/SMS provider not connected.",
  },
  {
    area: "Webhooks & integrations",
    scenario: "Signature verification, idempotency keys, retry with backoff, dead-letter",
    state: READINESS.BACKEND,
  },
  {
    area: "Marketplace configuration",
    scenario: "Admin-editable commission, payout delay, return window, listing rules, seller SLA",
    state: READINESS.PROTOTYPE,
    note: "Values editable in the prototype; persistence needs backend.",
  },
  {
    area: "Reporting & exports",
    scenario: "GMV, seller performance, returns analysis exports",
    state: READINESS.PARTIAL,
  },
  {
    area: "Audit log",
    scenario: "Immutable who/what/when/IP trail for sensitive actions",
    state: READINESS.PARTIAL,
    note: "Read-only demo log; append-only storage required.",
  },
  {
    area: "Security",
    scenario: "Auth, MFA, session revocation, rate limiting, PII encryption, RLS",
    state: READINESS.BACKEND,
    note: "PRODUCTION REQUIRED — nothing here is real security.",
  },
  {
    area: "Fraud & risk",
    scenario: "Risk scoring, velocity checks, chargeback handling",
    state: READINESS.MISSING,
  },
  {
    area: "Backups & disaster recovery",
    scenario: "Point-in-time restore, tested recovery runbook",
    state: READINESS.MISSING,
    note: "PRODUCTION REQUIRED.",
  },
  {
    area: "Error monitoring & alerting",
    scenario: "Crash reporting, job failure alerts, uptime checks",
    state: READINESS.MISSING,
    note: "PRODUCTION REQUIRED.",
  },
  {
    area: "Performance",
    scenario: "Lazy media, compact grids, mobile-first layout, no autoplay sound",
    state: READINESS.PROTOTYPE,
  },
];
...
export const MARKETPLACE_CONFIG: ConfigItem[] = [
  {
    ...
    value: "8",
    unit: "%",
    note: "Applied to GST-inclusive item value.",
  },
  {
    id: "comm_jewellery",
    group: "Commission",
    label: "Jewellery commission",
    value: "6",
    unit: "%",
  ...
  },
  {
    ...
    value: "10",
    unit: "%",
    note: "Opt-in campaign rate.",
  },
  {
    id: "payout_delay",
    group: "Payouts",
    label: "Payout delay after confirmed delivery",
    value: "14",
    unit: "days",
    note: "Eligibility clock start = confirmed delivery.",
  },
  {
    id: "payout_day",
    group: "Payouts",
    label: "Payout run",
    value: "Friday 5pm AEST",
    note: "Weekly batch.",
  },
  {
    id: "payout_min",
    ...
    value: "50",
    unit: "AUD",
    note: "Balances below roll into the next run.",
  },
  {
    id: "return_window",
    group: "Returns",
    ...
    value: "7",
    unit: "days",
    note: "From confirmed delivery. Statutory ACL claims are not limited by this.",
  },
  {
    id: "return_hold",
    group: "Returns",
    label: "Automatic payout hold on return",
    value: "Enabled",
    note: "Held until the return is resolved.",
  },
  {
    id: "listing_images",
    group: "Listings",
    ...
    value: "12",
    note: "First image is the thumbnail.",
  },
  {
    id: "listing_video",
    group: "Listings",
    label: "Product video limit",
    value: "1 × 60s × 200MB",
    note: "Muted by default, never autoplays with sound.",
  },
  {
    id: "listing_import",
    group: "Listings",
    label: "Bulk import rows per file",
    value: "1000",
    unit: "rows",
    note: "Larger files are queued as async batches.",
  },
  {
    id: "listing_review",
    group: "Listings",
    label: "Listing review",
    value: "Required for new sellers",
    note: "Auto-approve after 20 clean listings.",
  },
  {
    id: "sla_accept",
    group: "Seller SLA",
    label: "Accept order within",
    value: "24",
    unit: "hours",
    note: "Breach affects seller score.",
  },
  {
    id: "sla_dispatch",
    group: "Seller SLA",
    label: "Dispatch within handling time",
    value: "95",
    unit: "% on time",
    note: "Rolling 30-day target.",
  },
  {
    id: "sla_response",
    group: "Seller SLA",
...
export const BLANK_CELL_POLICIES = [
  {
    ...
    note: "Leave the existing value untouched. Safest for partial updates.",
  },
  {
    id: "clear",
    label: "CLEAR blank cells",
    note: "Treat a blank cell as an instruction to empty that field.",
  },
] as const;
...
export const IMPORT_BATCHES = [
  ...
  {
    id: "IMP-2026-0181",
    at: "12 Aug 2026 09:20",
    mode: "update" as ImportMode,
    rows: 640,
    ready: 640,
    warnings: 0,
    errors: 0,
  ...
  {
    id: "IMP-2026-0150",
    at: "02 Jul 2026 16:12",
    mode: "create" as ImportMode,
    rows: 240,
    ready: 0,
    warnings: 0,
    errors: 240,
    state: "Failed — wrong template version",
    tone: "bad" as Tone,
  },
];
...
export const CATEGORY_TREE = [
  ...
  },
  {
    ...
    categories: [
      ...
      {
        name: "Pooja",
        subs: ["Diyas", "Idols", "Pooja Thalis", "Incense", "Mandir Accessories", "Pooja Kits"],
      },
  ...
  },
  {
    ...
    categories: [
      {
        name: "Footwear",
        subs: ["Women's Juttis", "Punjabi Juttis", "Mojaris", "Kolhapuri Chappals"],
      },
    ],
  },
];
...
export const VIDEO_PIPELINE: {
...
}[] = [
  {
    state: "UPLOADING",
    tone: "info",
    detail: "Chunked upload in progress. Seller can cancel; partial files are discarded.",
  },
  {
    state: "UPLOADED",
    tone: "info",
    detail: "File received and checksummed. Not yet visible to customers.",
  },
  {
    state: "SAFETY CHECK",
    tone: "warn",
    detail: "Automated content screening plus manual review for flagged clips.",
  },
  {
    state: "PROCESSING / TRANSCODING",
    tone: "info",
    detail: "Transcoded to streaming renditions (1080p/720p/480p).",
  },
  {
    state: "THUMBNAIL GENERATED",
    tone: "info",
    detail: "Poster frame generated; seller may pick an alternate frame.",
  },
  {
    state: "READY",
    tone: "ok",
    detail: "Live on the product page. Muted by default — never autoplays with sound.",
  },
  {
    state: "FAILED / REJECTED",
    tone: "bad",
    detail:
      "Rejected by safety review or failed transcoding. Seller sees the reason and can re-upload.",
  },
];
