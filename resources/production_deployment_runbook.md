...
```
*Note: This script seeds 5 departments, 18 categories, 7 marketplace configs, and 3 storage buckets. It inserts zero test users, fake orders, or placeholder products.*
